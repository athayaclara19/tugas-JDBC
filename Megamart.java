...
public class Megamart {
    //Kode untuk menyambungkan ke SQL
    ...
    public static boolean login(String username, String password) {
        String validUsername = "Megamart";
        String validPassword = "MG1905";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Penjualan transaksi = new Penjualan(noFaktur, namaPelanggan, alamatPelanggan, nomorHP, kodeBarang, namaBarang, hargaBarang, jumlahBarang);
